...
# 任务是如何被执行的
在我的另外一篇文章[2.Zeta引擎源码讲解](../../../wiki/SeaTunnel/源码解析文章/2.Zeta引擎源码讲解.md)中有一些关于Zeta引擎的分析, 聊了一下Zeta引擎的客户端, 服务端都会做一些什么事情, 也笼统的带了一点任务执行的内容, 想了解相关内容的朋友可以去看一下.
...
生成计划图的过程的大致在第二篇文章中也有记录[2.Zeta引擎源码讲解](../../../wiki/SeaTunnel/源码解析文章/2.Zeta引擎源码讲解.md)
